...
Launch with ``python -m pouch_cell --ui`` (or
``streamlit run pouch_cell/ui/Overview.py``).

Pages
-----
* ``Overview.py`` -- current-settings summary + preset management.
...
* ``pages/3_Protocols.py`` -- discharge / charge / multi-step protocol.
* ``pages/4_Thermal.py`` -- cooling, heat pipe, thermal-map preview, overrides.
